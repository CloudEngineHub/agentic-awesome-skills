...
- **Inspect before installing**: the hosted [Skill Workbench](https://aaskills.me/workbench) reviews agent-produced stack manifests and immutable plans without browser-side installation.
...
- Compare the hosted [specialized plugin landing page](https://aaskills.me/plugins).
...
The hosted [Skill Workbench](https://aaskills.me/workbench) imports and reviews AAS Core stack manifests and immutable plans in browser memory. It does not access the filesystem, generate an approved plan, or install skills.
...
- **Hosted and local web app** in [`apps/web-app`](apps/web-app) and on [GitHub Pages](https://aaskills.me/)
...
- Browse the hosted catalog at [https://aaskills.me/](https://aaskills.me/).
